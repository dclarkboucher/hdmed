...
$\mathbf{M}$ be a set of $p$ variables, each a potential mediator in the causal
pathway between exposure $A$ and outcome $Y$, and let $\mathbb{C}$ be a set
of $q$ covariates, $q$ reasonably small. Then, given data on individuals
$i\in\{1,\dots,n\}$, with $n$ potentially but not necessarily less than $p$, we 
can evaluate the mediating role of $M$ with the models
